...
%% Zone
arrays.Post = zeros(1, params.quantity_connections, 'int8');
arrays.Pre = zeros(1, params.quantity_connections, 'int8');

%% Neurons
arrays.V_line = zeros(params.quantity_neurons, params.n);
arrays.V_line(:, 1) = params.v_0;
arrays.G = zeros(params.quantity_neurons, params.n);
